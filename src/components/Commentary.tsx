  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="inline-block px-4 py-1.5 bg-purple-50 dark:bg-purple-800/50 border border-purple-200 dark:border-purple-500 rounded-full mb-4"
      >
      ...
      >
        ...
        <p className="text-[#4a4458] dark:text-white text-lg leading-relaxed mt-2 italic">
