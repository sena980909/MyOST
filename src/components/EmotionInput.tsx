      ...
      <div className="relative">
        <textarea
          ...
          className="w-full bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border border-purple-100 dark:border-purple-800 rounded-2xl px-6 py-4
                     text-[#4a4458] dark:text-gray-100 placeholder-[#c4b5e0] dark:placeholder-purple-500 text-lg resize-none
          ...
          <span
            className={`text-xs ${
              text.length >= MAX_LENGTH
                ? "text-rose-400"
                : "text-[#c4b5e0] dark:text-purple-400"
            }`}
          >
            {text.length}/{MAX_LENGTH}
          </span>
      ...
      <div className="flex flex-wrap gap-2 mt-4 justify-center">
        {EXAMPLE_PROMPTS.map((prompt, index) => (
          <motion.button
            ...
            disabled={isLoading}
            className="px-3 py-1.5 text-xs bg-white/60 dark:bg-slate-800/60 border border-purple-100 dark:border-purple-800 rounded-full
                       text-[#8b7fa3] dark:text-purple-300 hover:text-[#6b5b8a] dark:hover:text-purple-200 hover:bg-white/80 dark:hover:bg-slate-800/80 hover:border-purple-200 dark:hover:border-purple-700
      ...
      >
        <button
          ...
          className="group relative px-8 py-4 bg-gradient-to-r from-pink-300 via-purple-300 to-blue-300
                     ...
                     dark:hover:from-pink-500 dark:hover:via-purple-500 dark:hover:to-blue-500
